    ...
    <div className=" md:bg-gray-100">
      <div className="px-6 md:flex justify-evenly pt-12 md:px-6 xl:px-64">
        <div className="border-0 border-black">
          <div>
            <h1 className="text-3xl sm:py-2 md:py-4">Hey there...</h1>
      ...
      <div className="md:flex justify-evenly pb-12 sm:pt-12 md:pt-24 md:px-6 lg:px-6 xl:px-64 xl:mx-0 md:gap-x-8 xl:gap-x-16 2xl:gap-x-32">
        <div className="m-6 md:m-0 pt-0 md:pt-0 border-4 border-light-blue-500 border-opacity-100 rounded-xl md:border-2 md:border-gray-100 md:rounded-xl text-center md:shadow-2xl mb-4">
          <p className="pt-8 md:pt-8 ">React</p>
          <p className="py-8 ">
